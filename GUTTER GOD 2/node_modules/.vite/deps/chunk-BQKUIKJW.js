...
import {
  extractMinAndMax,
  init_math_functions
} from "./chunk-DCHWUR36.js";
import {
  Viewport,
  init_math_viewport
} from "./chunk-LSDXYSSE.js";
import {
  ...
  "../../../node_modules/@babylonjs/core/Meshes/mesh.js"() {
    ...
    Mesh = class _Mesh extends AbstractMesh {
      ...
      _disposeInstanceDataStorageRenderPass(dataStorage, dispose = false) {
        if (dataStorage == null ? void 0 : dataStorage.instancesBuffer) {
          if (dispose) {
            dataStorage.instancesBuffer.dispose();
          }
          dataStorage.instancesBuffer = null;
        }
        if (dataStorage == null ? void 0 : dataStorage.instancesPreviousBuffer) {
          if (dispose) {
      ...
      _releaseRenderPassId(id) {
        ...
        if ((_a = this._userInstancedBuffersStorage) == null ? void 0 : _a.renderPasses) {
          const passVBOs = this._userInstancedBuffersStorage.renderPasses[id];
          if (passVBOs) {
            for (const kind in passVBOs) {
              (_b = passVBOs[kind]) == null ? void 0 : _b.dispose();
            }
          }
...
//# sourceMappingURL=chunk-BQKUIKJW.js.map
