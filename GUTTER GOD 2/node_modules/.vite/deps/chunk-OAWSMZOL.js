  ...
  "../../../node_modules/@babylonjs/core/scene.js"() {
    ...
    Scene = class _Scene {
      ...
      createSceneUniformBuffer(name, trackUBOsInFrameOrOptions) {
        const trackUBOsInFrame = typeof trackUBOsInFrameOrOptions === "boolean" ? trackUBOsInFrameOrOptions : trackUBOsInFrameOrOptions == null ? void 0 : trackUBOsInFrameOrOptions.trackUBOsInFrame;
      ...
      _renderForCamera(camera, rigParent, bindFrameBuffer = true) {
        ...
        if (this.renderTargetsEnabled) {
          ...
          if (this._renderTargets.length > 0) {
            ...
            const boundingBoxRenderer = (_b = this.getBoundingBoxRenderer) == null ? void 0 : _b.call(this);
          ...
          if (this._cameraDrawRenderTargetStage.length > 0) {
            const boundingBoxRenderer = (_c = this.getBoundingBoxRenderer) == null ? void 0 : _c.call(this);
            if (boundingBoxRenderer && !currentBoundingBoxMeshList) {
              currentBoundingBoxMeshList = boundingBoxRenderer.renderList.length > 0 ? boundingBoxRenderer.renderList.data.slice() : [];
              currentBoundingBoxMeshList.length = boundingBoxRenderer.renderList.length;
            }
      ...
      _renderWithFrameGraph(updateCameras = true, _ignoreAnimations = false, forceUpdateWorldMatrix = false) {
        ...
        this.onBeforeRenderTargetsRenderObservable.notifyObservers(this);
        this._renderTargets.reset();
        const currentActiveCamera = ((_a = this._frameGraph) == null ? void 0 : _a.findMainCamera()) ?? null;
        if (this.renderTargetsEnabled) {
          if (this.environmentTexture && this.environmentTexture.isRenderTarget) {
            this._renderTargets.pushNoDuplicate(this.environmentTexture);
          }
        ...
        (_b = this.frameGraph) == null ? void 0 : _b.execute();
      }
      /**
       * @internal
       */
...
//# sourceMappingURL=chunk-OAWSMZOL.js.map
