...
var name, shader, selectionOutlinePixelShader;
var init_selectionOutline_fragment = __esm({
  "../../../node_modules/@babylonjs/core/Shaders/selectionOutline.fragment.js"() {
    init_shaderStore();
    name = "selectionOutlinePixelShader";
    shader = `uniform sampler2D maskSampler;uniform sampler2D depthSampler;varying vec2 vUV;uniform vec2 screenSize;uniform vec3 outlineColor;uniform float outlineThickness;uniform float occlusionStrength;uniform float occlusionThreshold;
...
`;
    ...
    selectionOutlinePixelShader = { name, shader };
  }
});
...
//# sourceMappingURL=selectionOutline.fragment-764VNLKL.js.map
