...
var name, shader, selectionOutlinePixelShaderWGSL;
var init_selectionOutline_fragment = __esm({
  "../../../node_modules/@babylonjs/core/ShadersWGSL/selectionOutline.fragment.js"() {
    init_shaderStore();
    name = "selectionOutlinePixelShader";
    shader = `var maskSamplerSampler: sampler;var maskSampler: texture_2d<f32>;var depthSamplerSampler: sampler;var depthSampler: texture_2d<f32>;varying vUV: vec2f;uniform screenSize: vec2f;uniform outlineColor: vec3f;uniform outlineThickness: f32;uniform occlusionStrength: f32;uniform occlusionThreshold: f32;
...
`;
    ...
    selectionOutlinePixelShaderWGSL = { name, shader };
  }
});
init_selectionOutline_fragment();
export {
  selectionOutlinePixelShaderWGSL
};
//# sourceMappingURL=selectionOutline.fragment-T2SPCWEP.js.map
