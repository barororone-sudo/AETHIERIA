...
var init_instancedMesh = __esm({
  "../../../node_modules/@babylonjs/core/Meshes/instancedMesh.js"() {
    ...
    Mesh.prototype.registerInstancedBuffer = function(kind, stride) {
      ...
      if ((_c = this._userInstancedBuffersStorage) == null ? void 0 : _c.renderPasses) {
        for (const passId in this._userInstancedBuffersStorage.renderPasses) {
          ...
          (_d = passVBOs[kind]) == null ? void 0 : _d.dispose();
    ...
    Mesh.prototype._disposeInstanceSpecificData = function() {
      ...
      for (const renderPassId in this._instanceDataStorage.renderPasses) {
        (_a = this._instanceDataStorage.renderPasses[renderPassId].instancesBuffer) == null ? void 0 : _a.dispose();
      }
      this._instanceDataStorage.renderPasses = {};
      (_c = (_b = this._instanceDataStorage.dataStorageRenderPass) == null ? void 0 : _b.instancesBuffer) == null ? void 0 : _c.dispose();
...
//# sourceMappingURL=chunk-Q4AKYMWO.js.map
