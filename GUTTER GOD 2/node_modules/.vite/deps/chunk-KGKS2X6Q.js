...
} from "./chunk-ZOPZG7RY.js";
import {
  DumpDataAsync,
  init_dumpTools
} from "./chunk-WMICPHXQ.js";
import {
  PostProcess,
  SphericalPolynomial,
  init_postProcess,
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
  ...
  if (expandTexture) {
    if (engine.isWebGPU) {
      shaderLanguage = 1;
      await import("./rgbdDecode.fragment-KYJ5Q4OU.js");
    } else {
      await import("./rgbdDecode.fragment-XMPNHXL4.js");
    }
...
//# sourceMappingURL=chunk-KGKS2X6Q.js.map
