import {
  GetMappingForKey
} from "./chunk-SB3LLPN5.js";
import {
  deepMerge,
  init_deepMerger
} from "./chunk-UJLDK7ZQ.js";
import {
  GLTFFileLoader,
...
init_bufferUtils();
init_lazy();
var LazyAnimationGroupModulePromise = new Lazy(() => import("./animationGroup-Y6E24QV2.js"));
var LazyLoaderAnimationModulePromise = new Lazy(() => import("./glTFLoaderAnimation-RXPUNDI3.js"));
var ArrayItem = class {
  /**
      ...
      if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
        if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
          this._pbrMaterialImpl = {
            materialClass: (await import("./openpbrMaterial-A6GSGEEU.js")).OpenPBRMaterial,
            adapterClass: (await import("./openpbrMaterialLoadingAdapter-XJXGOL5S.js")).OpenPBRMaterialLoadingAdapter
          };
        } else {
          this._pbrMaterialImpl = {
            materialClass: (await import("./pbrMaterial-ZMYB3GHZ.js")).PBRMaterial,
            adapterClass: (await import("./pbrMaterialLoadingAdapter-YN42UQ5Z.js")).PBRMaterialLoadingAdapter
          };
        }
      }
...
//# sourceMappingURL=chunk-U2B7UPYH.js.map
