  ...
  "../../../node_modules/@babylonjs/core/Rendering/objectRenderer.js"() {
    ...
    ObjectRenderer = class _ObjectRenderer {
      ...
      _getSceneUBO() {
        ...
        const isMultiview = !!(activeRenderTarget && ((_a = activeRenderTarget.texture) == null ? void 0 : _a.isMultiview)) || !!this._scene._multiviewSceneUboIsActive;
    ...
    RenderTargetTexture = class _RenderTargetTexture extends Texture {
      ...
      isReadyForRendering() {
        if (!this._dumpToolsLoading) {
          ...
          import("./dumpTools-TR4IX5WG.js").then((module) => this._dumpTools = module);
        }
...
//# sourceMappingURL=chunk-SITY5KKU.js.map
