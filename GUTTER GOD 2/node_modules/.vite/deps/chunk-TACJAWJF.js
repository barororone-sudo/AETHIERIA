...
var onCreatedEffectParameters, Uniform, Property, Sampler, OpenPBRMaterialDefinesBase, OpenPBRMaterialDefines, OpenPBRMaterialBase, OpenPBRMaterial;
        ...
        const effect = engine.createEffect(shaderName, {
          ...
          extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
            if (this.shaderLanguage === 1) {
              await Promise.all([import("./openpbr.vertex-MF7EC4WW.js"), import("./openpbr.fragment-YMBTWBSZ.js")]);
            } else {
              await Promise.all([import("./openpbr.vertex-BXWOZR7Y.js"), import("./openpbr.fragment-ZKSXMGGK.js")]);
            }
...
//# sourceMappingURL=chunk-TACJAWJF.js.map
