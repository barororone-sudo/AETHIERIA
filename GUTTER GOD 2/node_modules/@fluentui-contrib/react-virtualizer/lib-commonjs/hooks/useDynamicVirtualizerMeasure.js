...
const useDynamicVirtualizerMeasure = (virtualizerProps)=>{
    ...
    const [virtualizerLength, setVirtualizerLength] = _react.useState(0);
    const [virtualizerBufferItems, setVirtualizerBufferItems] = _react.useState(0);
    const [virtualizerBufferSize, setVirtualizerBufferSize] = _react.useState(0);
    const scrollPosition = _react.useRef(0);
    const numItemsRef = _react.useRef(numItems);
    ...
    const resizeCallback = _react.useCallback((_entries, // TODO: exclude types from this lint rule: https://github.com/microsoft/fluentui/issues/31286
