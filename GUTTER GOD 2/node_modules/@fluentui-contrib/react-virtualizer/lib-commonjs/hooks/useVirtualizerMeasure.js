...
const useStaticVirtualizerMeasure = (virtualizerProps)=>{
    ...
    _observer, scrollRef)=>{
       ...
       * Minimum: 1
       */ const newBufferItems = bufferItems != null ? bufferItems : Math.max(Math.ceil(length / 4), 1);
        /*
       * This is how far we deviate into the bufferItems to detect a redraw.
       */ const newBufferSize = bufferSize != null ? bufferSize : Math.max(defaultItemSize / 2.0, 1);
