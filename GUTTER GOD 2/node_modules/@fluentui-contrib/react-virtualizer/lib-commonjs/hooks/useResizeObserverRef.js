...
const useResizeObserverRef_unstable = (resizeCallback)=>{
    ...
    const handleResize = (0, _debounce.debounce)(// eslint-disable-next-line no-restricted-globals
    (entries, observer)=>{
        var _container_current, _container_current1;
        const containerHeight = (_container_current = container.current) == null ? void 0 : _container_current.clientHeight;
        const containerWidth = (_container_current1 = container.current) == null ? void 0 : _container_current1.clientWidth;
        ...
        if (containerHeightRef.current !== containerHeight || containerWidth !== containerWidthRef.current) {
            containerWidthRef.current = containerWidth != null ? containerWidth : 0;
            containerHeightRef.current = containerHeight != null ? containerHeight : 0;
    ...
    const scrollRef = _react.useCallback((instance)=>{
        if (container.current !== instance) {
            if (container.current) {
                resizeObserver == null ? void 0 : resizeObserver.unobserve(container.current);
            }
            container.current = instance;
            if (container.current) {
                resizeObserver == null ? void 0 : resizeObserver.observe(container.current);
            }
        }
    }, [
        resizeObserver
