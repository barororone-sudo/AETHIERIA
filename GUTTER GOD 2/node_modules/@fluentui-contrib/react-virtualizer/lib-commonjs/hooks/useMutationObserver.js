...
const useMutationObserver = (target, callback, options)=>{
    ...
    useEffect(()=>{
        if (target) {
            ...
            _observer_current;
            (_observer_current = observer.current) == null ? void 0 : _observer_current.observe(target, options);
        }
        return ()=>{
            var _observer_current;
            (_observer_current = observer.current) == null ? void 0 : _observer_current.disconnect();
        };
    }, [
        target,
        options
