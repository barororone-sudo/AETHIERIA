...
import { Combobox, FluentProvider, Option, makeStyles, useId, useMergedRefs, useTimeout, webLightTheme } from '@fluentui/react-components';
...
export const VirtualizerExample = ({ numItems = 1000, itemSize = 50 })=>{
    ...
    }, "Add 10 Items"), /*#__PURE__*/ React.createElement("div", {
        className: styles.keyTestContainer,
        role: "list",
        ref: scrollRef,
        "data-testid": "scroll-container",
        "aria-label": "Virtualizer Example"
    }, /*#__PURE__*/ React.createElement(Virtualizer, {
...
export const VirtualizerComboboxExample = ()=>{
    ...
    return /*#__PURE__*/ React.createElement(FluentProvider, {
        ...
        htmlFor: `${comboId}`
    }, "Medium"), /*#__PURE__*/ React.createElement(Combobox, {
        id: `${comboId}`,
