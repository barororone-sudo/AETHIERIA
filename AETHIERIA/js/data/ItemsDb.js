...
export const ItemsDb = [
    ...
    { id: 'sword_fire', name: 'Lame Ardente', category: 'WEAPON', weaponType: 'SWORD', rarity: 3, element: 'pyro', stats: { damage: 220, speed: 1.1 }, visualStats: { color: '#FF4500', emissive: 1.0 }, skill: { name: 'Vague de Feu', cost: 40, type: 'AOE_FIRE' } },
    { id: 'sword_ice', name: 'Croc de Givre', category: 'WEAPON', weaponType: 'SWORD', rarity: 3, element: 'cryo', stats: { damage: 210, speed: 1.1 }, visualStats: { color: '#00FFFF', emissive: 1.0 }, skill: { name: 'Gel', cost: 35, type: 'FREEZE' } },
    { id: 'sword_lightning', name: 'Foudre', category: 'WEAPON', weaponType: 'SWORD', rarity: 4, element: 'electro', stats: { damage: 320, speed: 1.3 }, visualStats: { color: '#FFFF00', emissive: 2.0 }, skill: { name: 'Éclair', cost: 50, type: 'BOLT' } },
    { id: 'sword_plasma', name: 'Sabre Plasma', category: 'WEAPON', weaponType: 'SWORD', rarity: 4, element: 'electro', stats: { damage: 350, speed: 1.3 }, visualStats: { color: '#00FF00', emissive: 2.0, guardType: 'TECH' }, skill: { name: 'Surcharge', cost: 60, type: 'OVERLOAD' } },
    { id: 'sword_dark', name: 'Épée Maudite', category: 'WEAPON', weaponType: 'SWORD', rarity: 4, element: 'hydro', stats: { damage: 360, speed: 1.0 }, visualStats: { color: '#4B0082', emissive: 1.5 }, skill: { name: 'Vampirisme', cost: 45, type: 'DRAIN' } },
    { id: 'sword_excalibur', name: 'Excalibur', category: 'WEAPON', weaponType: 'SWORD', rarity: 5, element: 'anemo', stats: { damage: 600, speed: 1.2 }, visualStats: { color: '#FFFFFF', emissive: 3.0 }, skill: { name: 'Lumière Sacrée', cost: 100, type: 'NUKE' } },

    // --- GREATSWORDS (Slow, Heavy) ---
    { id: 'gs_wood', name: 'Massue en Bois', category: 'WEAPON', weaponType: 'GREATSWORD', rarity: 1, element: 'dendro', stats: { damage: 100, speed: 0.5 }, visualStats: { color: '#8B4513' }, skill: { name: 'Écrasement', cost: 20, type: 'SMASH' } },
    ...
    { id: 'gs_stone', name: 'Pilier Ancien', category: 'WEAPON', weaponType: 'GREATSWORD', rarity: 3, element: 'geo', stats: { damage: 300, speed: 0.4 }, visualStats: { color: '#808080', bladeLength: 1.8 }, skill: { name: 'Séisme', cost: 50, type: 'QUAKE' } },
    { id: 'gs_magma', name: 'Tranche-Montagne', category: 'WEAPON', weaponType: 'GREATSWORD', rarity: 5, element: 'pyro', stats: { damage: 700, speed: 0.5 }, visualStats: { color: '#FF4500', emissive: 2.0 }, skill: { name: 'Éruption', cost: 100, type: 'ERUPTION' } },
    { id: 'gs_crystal', name: 'Lame Prisme', category: 'WEAPON', weaponType: 'GREATSWORD', rarity: 4, element: 'electro', stats: { damage: 450, speed: 0.6 }, visualStats: { color: '#FF69B4', emissive: 1.0 }, skill: { name: 'Rayon', cost: 60, type: 'BEAM' } },
    { id: 'gs_void', name: 'Dévoreur', category: 'WEAPON', weaponType: 'GREATSWORD', rarity: 4, element: 'hydro', stats: { damage: 500, speed: 0.5 }, visualStats: { color: '#000000', emissive: 0.5 }, skill: { name: 'Trou Noir', cost: 80, type: 'GRAVITY' } },
    // More Greatswords...
    ...
    { id: 'gs_titan', name: 'Titan', category: 'WEAPON', weaponType: 'GREATSWORD', rarity: 5, element: 'geo', stats: { damage: 800, speed: 0.4 }, visualStats: { color: '#B8860B', emissive: 1.0 }, skill: { name: 'Impact', cost: 90, type: 'IMPACT' } },
    ...
    { id: 'dagger_poison', name: 'Croc Venimeux', category: 'WEAPON', weaponType: 'DAGGER', rarity: 2, element: 'dendro', stats: { damage: 70, speed: 2.6 }, visualStats: { color: '#00FF00', emissive: 0.5 }, skill: { name: 'Poison', cost: 25, type: 'POISON' } },
    { id: 'dagger_void', name: 'Croc du Néant', category: 'WEAPON', weaponType: 'DAGGER', rarity: 3, element: 'hydro', stats: { damage: 120, speed: 3.0 }, visualStats: { color: '#9400D3', emissive: 1.5 }, skill: { name: 'Téléport', cost: 40, type: 'BLINK' } },
    ...
    { id: 'dagger_blood', name: 'Soif de Sang', category: 'WEAPON', weaponType: 'DAGGER', rarity: 3, element: 'pyro', stats: { damage: 100, speed: 2.8 }, visualStats: { color: '#8B0000', emissive: 0.8 }, skill: { name: 'Saignement', cost: 30, type: 'BLEED' } },
    { id: 'dagger_wind', name: 'Souffle', category: 'WEAPON', weaponType: 'DAGGER', rarity: 4, element: 'anemo', stats: { damage: 140, speed: 3.2 }, visualStats: { color: '#E0FFFF' }, skill: { name: 'Tornade', cost: 45, type: 'WIND' } },
    { id: 'dagger_dragon', name: 'Griffe de Dragon', category: 'WEAPON', weaponType: 'DAGGER', rarity: 5, element: 'pyro', stats: { damage: 250, speed: 3.0 }, visualStats: { color: '#FFD700', emissive: 1.0 }, skill: { name: 'Exécution', cost: 80, type: 'KILL' } },
    { id: 'dagger_chaos', name: 'Chaos', category: 'WEAPON', weaponType: 'DAGGER', rarity: 5, element: 'electro', stats: { damage: 280, speed: 3.5 }, visualStats: { color: '#FF00FF', emissive: 2.0 }, skill: { name: 'Folie', cost: 90, type: 'CHAOS' } },

    // --- SPEARS (Reach) ---
    { id: 'spear_wood', name: 'Lance en Bois', category: 'WEAPON', weaponType: 'SPEAR', rarity: 1, element: 'dendro', stats: { damage: 70, speed: 1.2 }, visualStats: { color: '#DEB887' }, skill: { name: 'Piquée', cost: 15, type: 'POKE' } },
    ...
    { id: 'spear_trident', name: 'Trident', category: 'WEAPON', weaponType: 'SPEAR', rarity: 3, element: 'hydro', stats: { damage: 180, speed: 1.1 }, visualStats: { color: '#00BFFF' }, skill: { name: 'Vague', cost: 40, type: 'WAVE' } },
